    ...
    return ( 
        <div className="navbar">
            <div className="my-6 lg:my-12 container px-6 mx-auto flex flex-col md:flex-row items-start md:items-center justify-between pb-4 border-b border-gray-300">
                <div>
                    <h4 className="text-2xl font-bold leading-tight text-gray-800 dark:text-gray-100">User Profile
                    {isLoggedIn ? (
                        <div>
                        <button onClick={callLogin}>Toggle login</button>
                        <button onClick={callLogin2}>Toggle login2</button>
                        <button>
                            <img className="profile-pic" src={profile.picture} alt="not found" />
