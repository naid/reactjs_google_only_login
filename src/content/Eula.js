const Eula = () => {
    return ( <div className="eula leading-loose max-w-2xl">
        <p className="text-center">Please read thie end user license agreement before starting with NaidFinances</p>
        <h1 className="text-center text-4xl font-bold leading-tight tracking-tight text-slate-900 sm:text-4xl">End-User License Agreement (&quot;Agreement&quot;)</h1>
        <p className="text-center">Last updated: May 22, 2023</p>
        <p className="text-center">Please read this End-User License Agreement carefully before clicking the &quot;I Agree&quot; button, downloading or using NaidFinances.</p>
        <p className="m-8"></p>
        <h1 className="m-2 text-center text-3xl font-bold tracking-tight text-slate-900 sm:text-3xl">Interpretation and Definitions</h1>
...
<ul className="list-disc">
  <li>
    <p>
      <strong>Agreement</strong> means this End-User License Agreement that forms the entire agreement between You and the Company regarding the use of the Application. This Agreement has been created with the help of the <a href="https://www.termsfeed.com/eula-generator/" target="_blank">TermsFeed EULA Generator</a>.
    </p>
  </li>
  <li>
    <p>
      <strong>Application</strong> means the software program provided by the Company downloaded by You to a Device, named NaidFinances
    </p>
  </li>
  <li>
    <p>
      <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to NaidSystems Inc, Comillas, La Paz, Tarlac.
    </p>
  </li>
  <li>
    <p>
...
<h1 className="texl-xl font-bold">Acknowledgment</h1>
...
<ul>
  <li>By email: naid.rm@gmail.com</li>
</ul>
    </div> );
}
